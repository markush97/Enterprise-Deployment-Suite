...
interface CustomerModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSave: (data: NewCustomer | Customer) => Promise<void>;
}
...
export function CustomerModal({ customer, isOpen, onClose, onSave }: CustomerModalProps) {
  ...
  useEffect(() => {
    if (customer) {
      setFormData({
        ...
        pulsewayId: customer.pulsewayId,
  ...
  const validate = (): boolean => {
    ...
    if (!formData.pulsewayId.trim()) {
      newErrors.pulsewayId = 'Pulseway ID is required';
    }
        ...
        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          ...
          <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-6">
              ...
              <div>
                <label htmlFor="defaultClientImage" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  Default Client Image (Optional)
                </label>
                <input
                  type="text"
                  name="defaultClientImage"
                  id="defaultClientImage"
                  ...
                  onChange={(e) => {
                    setFormData({
                      ...
                      settings: {
                        ...formData.settings,
                        defaultClientImage: e.target.value
                      }
                    });
                  }}
