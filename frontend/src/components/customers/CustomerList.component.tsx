...
import { EntityList, EntityListAction, EntityListColumn } from '../utils/EntityList';
...
export function CustomerList() {
  ...
  const { customersQuery, addCustomerMutation, updateCustomerMutation, deleteCustomerMutation } =
    useCustomers();
