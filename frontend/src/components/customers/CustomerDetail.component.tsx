        ...
        <div className="px-6 py-4">
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
            <div>
              ...
              <dd className="mt-1 text-lg text-gray-900 dark:text-white">{customer.name}</dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Short Code</dt>
              <dd className="mt-1 text-lg text-gray-900 dark:text-white">{customer.shortCode}</dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Pulseway ID</dt>
            ...
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Zoho ID</dt>
              <dd className="mt-1 text-lg text-gray-900 dark:text-white flex items-center gap-2">
                {customer.zohoId ? (
            ...
            <div>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">IT-Glue ID</dt>
              <dd className="mt-1 text-lg text-gray-900 dark:text-white flex items-center gap-2">
                {customer.itGlueId ? (
